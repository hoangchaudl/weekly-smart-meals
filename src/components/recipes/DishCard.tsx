...
import { Clock, Users, Snowflake, Refrigerator } from 'lucide-react';
...
export function DishCard({ recipe, onClick, compact = false, className }: DishCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        'floating-card card-hover cursor-pointer group',
        compact ? 'p-4' : 'p-6',
        className
      )}
    >
